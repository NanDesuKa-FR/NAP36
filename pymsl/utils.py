...
# Embedded file name: lib\site-packages\pymsl\utils.py
...
def msl_encrypt(msl_session, plaintext):
    ...
    encryption_envelope = {'keyid':'%s_%s' % (
      msl_session['esn'],
    ...
    cipher = AES.new(msl_session['session_keys']['encryption_key'], AES.MODE_CBC, cbc_iv)
