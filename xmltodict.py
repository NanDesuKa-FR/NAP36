...
# Embedded file name: lib\site-packages\xmltodict.py
                    ...
                    if isinstance(v, bool):
                        ...
                        for child_key, child_value in children:
                            _emit(child_key, child_value, content_handler, attr_prefix,
                              cdata_key, (depth + 1), preprocessor, pretty,
                              newl, indent, namespaces=namespaces, namespace_separator=namespace_separator)
