...
# Embedded file name: lib\site-packages\google\protobuf\internal\decoder.py
...
_DecodeVarint = _VarintDecoder(18446744073709551615, int)
_DecodeSignedVarint = _SignedVarintDecoder(64, int)
_DecodeVarint32 = _VarintDecoder(4294967295, int)
  ...
  """
    ...
    def InnerDecode(buffer, pos):
        ...
        if double_bytes[7:8] in b'\x7f\xff':
            if double_bytes[6:7] >= b'\xf0':
                if double_bytes[0:7] != b'\x00\x00\x00\x00\x00\x00\xf0':
                    return (
                     _NAN, new_pos)
