...
# Embedded file name: lib\site-packages\google\protobuf\descriptor_pool.py
...
class DescriptorPool(object):
         ...
         (
          self._toplevel_extensions, descriptor.FieldDescriptor)]:
            if desc_name in register:
                ...
                if not isinstance(desc, descriptor_type) or file_name != desc.file.name:
                    warn_msg = 'Conflict register for file "' + desc.file.name + '": ' + desc_name + ' is already defined in file "' + file_name + '"'
    ...
    """
        if file_proto.name not in self._file_descriptors:
            ...
            for dependency in built_deps:
                scope.update(self._ExtractSymbols(list(dependency.message_types_by_name.values())))
                scope.update((_PrefixWithDot(enum.full_name), enum) for enum in list(dependency.enum_types_by_name.values()))
    ...
    """
        ...
        for extension_proto, extension_desc in list(zip(desc_proto.extension, main_desc.extensions)):
