...
# Embedded file name: Nap36Src\pywidevine\decrypt\netflix36_keys_hevc.py
if __name__ == 'pywidevine.decrypt.netflix36_keys_hevc':
    ...
    def GettingKEYS_Netflix(nfID):
        ...
        global rsa_key_bin
        rsa_key_bin = 'rsa_keys_hevc.bin'
        msl_data_file = 'msl_data_keys_hevc.json'
        manifest_file = 'manifest_keys_hevc.json'
        ...
        print('\nGetting HEVC and HDR-10 Keys...')
        manifest_keys_hevc = str(MSL.load_manifest(MSL(int(nfID)), int(nfID)))
        KEYS = []
        if 'hevc-main10-L' not in manifest_keys_hevc:
            return KEYS
        else:
