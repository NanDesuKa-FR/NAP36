...
# Embedded file name: Nap36Src\pywidevine\decrypt\netflix36_MSL_high.py
if __name__ == 'pywidevine.decrypt.netflix36_MSL_high':
    ...
    class MSL:
        ...
        def __init__(self, test):
            ...
            global rsa_key_bin
            rsa_key_bin = 'rsa_manifest_high.bin'
            msl_data_file = 'msl_data_manifest_high.json'
            manifest_file = 'manifest_high.json'
        ...
        def load_manifest(self, viewable_id):
            ...
            client = pymsl.MslClient({'scheme':'EMAIL_PASSWORD', 
             ...
             'playready-h264mpl22-dash', 'playready-h264mpl30-dash',
             'playready-h264mpl31-dash', 'playready-h264mpl40-dash',
             'heaac-2-dash', 'simplesdh'])
        ...
        def __tranform_to_dash(self, manifest):
            ...
            init_length = seconds / 2 * 12 + 20000
            ...
            for video_track in manifest['videoTracks']:
                ...
                protection = ET.SubElement(video_adaption_set, 'ContentProtection', schemeIdUri='urn:uuid:EDEF8BA9-79D6-4ACE-A3C8-27DCD51D21ED')
                if pssh is not '':
                ...
                for downloadable in video_track['downloadables']:
                    ...
                    rep = ET.SubElement(video_adaption_set, 'Representation', width=(str(downloadable['width'])), height=(str(downloadable['height'])),
                      bandwidth=(str(downloadable['bitrate'] * 1024)),
                      hdcp=hdcp_versions,
                      nflxContentProfile=(str(downloadable['contentProfile'])),
                      codecs=codec,
                      mimeType='video/mp4')
                    ET.SubElement(rep, 'BaseURL').text = self._MSL__get_base_url(downloadable['urls'])
