...
# Embedded file name: Nap36Src\pywidevine\decrypt\netflix36_keys_vp9.py
if __name__ == 'pywidevine.decrypt.netflix36_keys_vp9':
    ...
    def GettingKEYS_Netflix(nfID):
        ...
        global rsa_key_bin
        rsa_key_bin = 'rsa_keys_vp9.bin'
        msl_data_file = 'msl_data_keys_vp9.json'
        manifest_file = 'manifest_keys_vp9.json'
        ...
        print('\nGetting VP9 Profile Keys...')
        manifest_keys_vp9 = str(MSL.load_manifest(MSL(int(nfID)), int(nfID)))
        KEYS = []
        if 'vp9-profile' not in manifest_keys_vp9:
            return KEYS
        else:
