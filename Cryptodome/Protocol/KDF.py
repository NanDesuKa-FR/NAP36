...
# Embedded file name: lib\site-packages\Cryptodome\Protocol\KDF.py
import struct
...
class _S2V(object):
    __doc__ = 'String-to-vector PRF as defined in `RFC5297`_.\n\n    This class implements a pseudorandom function family\n    based on CMAC that takes as input a vector of strings.\n\n    .. _RFC5297: http://tools.ietf.org/html/rfc5297\n    '
    ...
    def update(self, item):
        ...
        self._n_updates -= 1
        mac = CMAC.new((self._key), msg=(self._last_string),
    ...
    def derive(self):
        ...
        mac = CMAC.new((self._key), msg=final,
          ciphermod=(self._ciphermod),
          cipher_params=(self._cipher_params))
        return mac.digest()
...
def scrypt(password, salt, key_len, N, r, p, num_keys=1):
    ...
    dk = PBKDF2(password, ((b'').join(data_out)),
      (key_len * num_keys),
      1, prf=prf_hmac_sha256)
    if num_keys == 1:
        return dk
    else:
