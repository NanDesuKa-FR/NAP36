...
# Embedded file name: lib\site-packages\Cryptodome\IO\PKCS8.py
from Cryptodome.Util.py3compat import *
from Cryptodome.Util.asn1 import DerNull, DerSequence, DerObjectId, DerOctetString
...
def unwrap(p8_private_key, passphrase=None):
    ...
    return (
     algo_oid, private_key, algo_params)