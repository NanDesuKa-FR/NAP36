...
# Embedded file name: lib\site-packages\Cryptodome\Cipher\_mode_ocb.py
"""
...
class OcbMode(object):
    ...
    def __init__(self, factory, nonce, mac_len, cipher_params):
        if factory.block_size != 16:
            ...
            ktop_cipher = (factory.new)(key, 
             (factory.MODE_ECB), **params_without_key)
            ...
            result = _raw_ocb_lib.OCB_start_operation(raw_cipher.get(), offset_0, c_size_t(len(offset_0)), self._state.address_of())
            if result:
    ...
    def update(self, assoc_data):
        ...
        self._next = [
         self.encrypt, self.decrypt, self.digest,
    ...
    def encrypt_and_digest(self, plaintext):
        ...
        """
        return (
         self.encrypt(plaintext) + self.encrypt(), self.digest())
