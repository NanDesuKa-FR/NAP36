...
# Embedded file name: lib\site-packages\Cryptodome\Cipher\_mode_eax.py
"""
EAX mode.
"""
__all__ = [
...
class EaxMode(object):
    ...
    def __init__(self, factory, key, nonce, mac_len, cipher_params):
        ...
        self._omac = [CMAC.new(key, (b'\x00' * (self.block_size - 1) + struct.pack('B', i)), ciphermod=factory, cipher_params=cipher_params) for i in range(0, 3)]
        self._omac[0].update(self.nonce)
        self._signer = self._omac[1]
        counter_int = bytes_to_long(self._omac[0].digest())
        self._cipher = (factory.new)(key,
 factory.MODE_CTR, initial_value=counter_int, 
