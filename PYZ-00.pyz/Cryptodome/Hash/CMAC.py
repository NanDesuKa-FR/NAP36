...
# Embedded file name: lib\site-packages\Cryptodome\Hash\CMAC.py
import sys
...
class CMAC(object):
    ...
    def __init__(self, key, msg, ciphermod, cipher_params, mac_len, update_after_digest):
        ...
        self._cbc = (ciphermod.new)(key, 
         (ciphermod.MODE_CBC), 
         zero_block, **self._cipher_params)
    ...
    def copy(self):
        ...
        obj._cbc = (self._factory.new)((self._key), 
         ...
         (self._last_ct), **self._cipher_params)
    ...
    def digest(self):
        ...
        elif self._cache_n == 0 and self._data_size > 0:
