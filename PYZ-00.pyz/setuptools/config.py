...
# Embedded file name: lib\site-packages\setuptools-39.0.1-py3.6.egg\setuptools\config.py
...
def parse_configuration(distribution, command_options, ignore_option_errors=False):
    ...
    :rtype: list
    """
    meta = ConfigMetadataHandler(distribution.metadata, command_options, ignore_option_errors)
    meta.parse()
