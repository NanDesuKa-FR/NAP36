...
class Pool(object):
 ...
 L. 413         0  LOAD_GLOBAL              threading
                2  LOAD_ATTR                current_thread
                4  CALL_FUNCTION_0       0  '0 positional arguments'
                6  STORE_FAST               'thread'

 L. 415         8  SETUP_LOOP          256  'to 256'
               10  LOAD_GLOBAL              iter
               12  LOAD_FAST                'taskqueue'
               14  LOAD_ATTR                get
               16  LOAD_CONST               None
               18  CALL_FUNCTION_2       2  '2 positional arguments'
               20  GET_ITER         
               22  FOR_ITER            244  'to 244'
               24  UNPACK_SEQUENCE_2     2 
               26  STORE_FAST               'taskseq'
               28  STORE_FAST               'set_length'

 L. 416        30  LOAD_CONST               None
               32  STORE_FAST               'task'

 L. 417        34  SETUP_FINALLY       228  'to 228'

 L. 419        36  SETUP_LOOP          222  'to 222'
               38  LOAD_FAST                'taskseq'
               40  GET_ITER         
               42  FOR_ITER            176  'to 176'
               44  STORE_FAST               'task'

 L. 420        46  LOAD_FAST                'thread'
               48  LOAD_ATTR                _state
               50  POP_JUMP_IF_FALSE    64  'to 64'

 L. 421        52  LOAD_GLOBAL              util
               54  LOAD_ATTR                debug
 ...
 L. 423        64  SETUP_EXCEPT         78  'to 78'

 L. 424        66  LOAD_FAST                'put'
               68  LOAD_FAST                'task'
               70  CALL_FUNCTION_1       1  '1 positional argument'
               72  POP_TOP          
               74  POP_BLOCK        
               76  JUMP_BACK            42  'to 42'
             78_0  COME_FROM_EXCEPT     64  '64'

 L. 425        78  DUP_TOP          
               80  LOAD_GLOBAL              Exception
               82  COMPARE_OP               exception-match
               84  POP_JUMP_IF_FALSE   172  'to 172'
               86  POP_TOP          
               88  STORE_FAST               'e'
               90  POP_TOP          
               92  SETUP_FINALLY       162  'to 162'

 L. 426        94  LOAD_FAST                'task'
               96  LOAD_CONST               None
               98  LOAD_CONST               2
              100  BUILD_SLICE_2         2 
              102  BINARY_SUBSCR    
 ...
 L. 427       110  SETUP_EXCEPT        136  'to 136'

 L. 428       112  LOAD_FAST                'cache'
              114  LOAD_FAST                'job'
              116  BINARY_SUBSCR    
              118  LOAD_ATTR                _set
              120  LOAD_FAST                'idx'
            ...
            136_0  COME_FROM_EXCEPT    110  '110'

 L. 429       136  DUP_TOP          
              138  LOAD_GLOBAL              KeyError
 ...
 L. 430       150  POP_EXCEPT       
            ...
            156_1  COME_FROM           134  '134'
              ...
              158  POP_EXCEPT       
              160  LOAD_CONST               None
            162_0  COME_FROM_FINALLY    92  '92'
              162  LOAD_CONST               None
              164  STORE_FAST               'e'
              166  DELETE_FAST              'e'
              168  END_FINALLY      
              170  JUMP_BACK            42  'to 42'
              172  END_FINALLY      
              174  JUMP_BACK            42  'to 42'
              176  POP_BLOCK        

 L. 432       178  LOAD_FAST                'set_length'
              180  POP_JUMP_IF_FALSE   220  'to 220'

 L. 433       182  LOAD_GLOBAL              util
              184  LOAD_ATTR                debug
              186  LOAD_STR                 'doing set_length()'
              188  CALL_FUNCTION_1       1  '1 positional argument'
              190  POP_TOP          

 L. 434       192  LOAD_FAST                'task'
 ...
 L. 435       208  LOAD_FAST                'set_length'
              210  LOAD_FAST                'idx'
              212  LOAD_CONST               1
              214  BINARY_ADD       
 ...
 L. 436       220  CONTINUE_LOOP        22  'to 22'
            222_0  COME_FROM_LOOP       36  '36'

 L. 437       222  BREAK_LOOP       
              224  POP_BLOCK        
              226  LOAD_CONST               None
            228_0  COME_FROM_FINALLY    34  '34'

 L. 439       228  LOAD_CONST               None
              230  DUP_TOP          
              232  STORE_FAST               'task'
              234  DUP_TOP          
              236  STORE_FAST               'taskseq'
              238  STORE_FAST               'job'
              240  END_FINALLY      
              242  JUMP_BACK            22  'to 22'
              244  POP_BLOCK        

 L. 441       246  LOAD_GLOBAL              util
              248  LOAD_ATTR                debug
              250  LOAD_STR                 'task handler got sentinel'
              252  CALL_FUNCTION_1       1  '1 positional argument'
              254  POP_TOP          
            256_0  COME_FROM_LOOP        8  '8'

 L. 443       256  SETUP_EXCEPT        316  'to 316'

 L. 445       258  LOAD_GLOBAL              util
              260  LOAD_ATTR                debug
              262  LOAD_STR                 'task handler sending sentinel to result handler'
              264  CALL_FUNCTION_1       1  '1 positional argument'
              266  POP_TOP          

 L. 446       268  LOAD_FAST                'outqueue'
              270  LOAD_ATTR                put
              272  LOAD_CONST               None
              274  CALL_FUNCTION_1       1  '1 positional argument'
              276  POP_TOP          

 L. 449       278  LOAD_GLOBAL              util
              280  LOAD_ATTR                debug
              282  LOAD_STR                 'task handler sending sentinel to workers'
              284  CALL_FUNCTION_1       1  '1 positional argument'
              286  POP_TOP          

 L. 450       288  SETUP_LOOP          312  'to 312'
              290  LOAD_FAST                'pool'
              292  GET_ITER         
              294  FOR_ITER            310  'to 310'
              296  STORE_FAST               'p'

 L. 451       298  LOAD_FAST                'put'
              300  LOAD_CONST               None
              302  CALL_FUNCTION_1       1  '1 positional argument'
              304  POP_TOP          
              306  JUMP_BACK           294  'to 294'
              310  POP_BLOCK        
            312_0  COME_FROM_LOOP      288  '288'
              312  POP_BLOCK        
              314  JUMP_FORWARD        348  'to 348'
            316_0  COME_FROM_EXCEPT    256  '256'

 L. 452       316  DUP_TOP          
              318  LOAD_GLOBAL              OSError
 ...
 L. 453       332  LOAD_GLOBAL              util
              334  LOAD_ATTR                debug
              336  LOAD_STR                 'task handler got OSError when sending sentinels'
            ...
            348_1  COME_FROM           314  '314'

 L. 455       348  LOAD_GLOBAL              util
              350  LOAD_ATTR                debug
              352  LOAD_STR                 'task handler exiting'
