...
# Embedded file name: lib\site-packages\cryptography\hazmat\bindings\openssl\binding.py
from __future__ import absolute_import, division, print_function
import collections, threading, types, warnings
...
def _verify_openssl_version(lib):
    if lib.CRYPTOGRAPHY_OPENSSL_LESS_THAN_102:
        if not lib.CRYPTOGRAPHY_IS_LIBRESSL:
            warnings.warn('OpenSSL version 1.0.1 is no longer supported by the OpenSSL project, please upgrade. A future version of cryptography will drop support for it.', utils.CryptographyDeprecationWarning)
