...
# Embedded file name: lib\site-packages\cryptography\hazmat\backends\openssl\x509.py
from __future__ import absolute_import, division, print_function
import datetime, operator, warnings
from cryptography import utils, x509
from cryptography.exceptions import UnsupportedAlgorithm
from cryptography.hazmat.backends.openssl.decode_asn1 import _CERTIFICATE_EXTENSION_PARSER, _CERTIFICATE_EXTENSION_PARSER_NO_SCT, _CRL_EXTENSION_PARSER, _CSR_EXTENSION_PARSER, _REVOKED_CERTIFICATE_EXTENSION_PARSER, _asn1_integer_to_int, _asn1_string_to_bytes, _decode_x509_name, _obj2txt, _parse_asn1_time
from cryptography.hazmat.backends.openssl.encode_asn1 import _encode_asn1_int_gc
...
class _Certificate(object):
    ...
    def version(self):
        ...
        raise x509.InvalidVersion('{0} is not a valid X509 version'.format(version), version)

    @property
    def serial(self):
        warnings.warn('Certificate serial is deprecated, use serial_number instead.',
    ...
    def extensions(self):
        if self._backend._lib.CRYPTOGRAPHY_OPENSSL_110_OR_GREATER:
            ...
            return _CERTIFICATE_EXTENSION_PARSER_NO_SCT.parse(self._backend, self._x509)
...
class _RevokedCertificate(object):
    ...
    @utils.cached_property
    def extensions(self):
        return _REVOKED_CERTIFICATE_EXTENSION_PARSER.parse(self._backend, self._x509_revoked)
