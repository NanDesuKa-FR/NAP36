...
# Embedded file name: lib\site-packages\cryptography\hazmat\backends\openssl\dsa.py
...
class _DSAPrivateKey(object):
    ...
    def private_bytes(self, encoding, format, encryption_algorithm):
        return self._backend._private_key_bytes(encoding, format, encryption_algorithm, self._evp_pkey, self._dsa_cdata)
...
class _DSAPublicKey(object):
    ...
    def public_bytes(self, encoding, format):
        if format is serialization.PublicFormat.PKCS1:
            raise ValueError('DSA public keys do not support PKCS1 serialization')
