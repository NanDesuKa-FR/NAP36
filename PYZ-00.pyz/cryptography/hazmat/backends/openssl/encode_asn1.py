...
# Embedded file name: lib\site-packages\cryptography\hazmat\backends\openssl\encode_asn1.py
                ...
                if isinstance(name, x509.IPAddress):
                    ...
                    if isinstance(name.value, ipaddress.IPv4Network):
                        ...
                        if isinstance(name.value, ipaddress.IPv6Network):
                            packed = name.value.network_address.packed + utils.int_to_bytes(340282366920938463463374607431768211456 - name.value.num_addresses, 16)
                        else:
                    ...
                    if isinstance(name, x509.OtherName):
                        ...
                        if isinstance(name, x509.RFC822Name):
                            ...
                            if isinstance(name, x509.UniformResourceIdentifier):
                                ...
                                raise ValueError('{0} is an unknown GeneralName type'.format(name))
    return gn
