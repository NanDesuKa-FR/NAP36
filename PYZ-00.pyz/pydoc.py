...
def visiblename(name, all=None, obj=None):
    ...
    if name in frozenset({'__qualname__', '__doc__', '__builtins__', '__spec__', '__loader__', '__cached__', '__credits__', '__path__', '__slots__', '__package__', '__date__', '__author__', '__name__', '__module__', '__file__', '__version__'}):
        return 0
    else:
...
class Helper:
    keywords = {'False':'', 
     ...
     'yield':('yield', '')}
    _symbols_inverse = {'STRINGS':("'", "'''", "r'", "b'", '"""', '"', 'r"', 'b"'), 
     'OPERATORS':('+', '-', '*', '**', '/', '//', '%', '<<', '>>', '&', '|', '^', '~', '<', '>', '<=',
 '>=', '==', '!=', '<>'), 
     'COMPARISON':('<', '>', '<=', '>=', '==', '!=', '<>'), 
     'UNARY':('-', '~'), 
