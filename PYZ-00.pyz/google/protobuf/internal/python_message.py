...
# Embedded file name: lib\site-packages\google\protobuf\internal\python_message.py
    ...
    def InternalParse(self, buffer, pos, end):
        ...
        while pos != end:
            ...
            if field_decoder is None:
                ...
                if new_pos == -1:
                    return pos
                if not is_proto3 or api_implementation.GetPythonProto3PreserveUnknownsDefault():
...
class _ExtensionDict(object):
    __doc__ = 'Dict-like container for supporting an indexable "Extensions"\n  field on proto instances.\n\n  Note that in all cases we expect extension handles to be\n  FieldDescriptors.\n  '
