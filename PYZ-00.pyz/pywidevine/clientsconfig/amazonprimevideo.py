...
# Embedded file name: Nap36Src\pywidevine\clientsconfig\amazonprimevideo.py
...
config = {}
config['ps'] = {'cookies_file':'cookies_ps.txt',  'site_base_url':'www.primevideo.com', 
 ...
 'proxies':None}
config['ps-int'] = {'cookies_file':'cookies_ps-int.txt',  'site_base_url':'www.primevideo.com', 
 'video_base_url':'atv-ps.primevideo.com', 
 'marketplace_id':'ART4WZ8MWBX2Y', 
 'clientId':'f22dbddb-ef2c-48c5-8876-bed0d47594fd', 
 'email':email_pv_no_european, 
 'password':password_pv_no_european, 
 'proxies':None}
config['us'] = {'cookies_file':'cookies_us.txt',  'site_base_url':'www.amazon.com', 
 ...
 'proxies':None}
config['jp'] = {'cookies_file':'cookies_jap.txt',  'site_base_url':'www.amazon.co.jp', 
 ...
 'proxies':None}
config['uk'] = {'cookies_file':'cookies_uk.txt',  'site_base_url':'www.amazon.co.uk', 
 ...
 'proxies':None}
config['de'] = {'cookies_file':'cookies_de.txt',  'site_base_url':'www.amazon.de', 
...
class PrimevideoConfig(object):
    ...
    def configPrimeVieo():
        ...
        return (
         video_base_url, site_base_url, marketplace_id, cookies_file, clientId, email, password)
