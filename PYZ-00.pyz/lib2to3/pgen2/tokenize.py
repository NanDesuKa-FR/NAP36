...
endprogs = {"'":re.compile(Single),  '"':re.compile(Double),  "'''":single3prog, 
 ...
 'b"""':double3prog,  "f'''":single3prog, 
 'f"""':double3prog,  "ur'''":single3prog, 
 'ur"""':double3prog,  "br'''":single3prog, 
 'br"""':double3prog,  "rb'''":single3prog, 
 'rb"""':double3prog,  "R'''":single3prog, 
 'R"""':double3prog,  "U'''":single3prog, 
 'U"""':double3prog,  "B'''":single3prog, 
 'B"""':double3prog,  "F'''":single3prog, 
 'F"""':double3prog,  "uR'''":single3prog, 
 ...
 'Br"""':double3prog,  "BR'''":single3prog, 
 'BR"""':double3prog,  "rB'''":single3prog, 
 'rB"""':double3prog,  "Rb'''":single3prog, 
 'Rb"""':double3prog,  "RB'''":single3prog, 
 'RB"""':double3prog,  'r':None, 
 'R':None,  'u':None, 
 'U':None,  'f':None, 
 'F':None,  'b':None, 
 'B':None}
...
for t in ("'''", '"""', "r'''", 'r"""', "R'''", 'R"""', "u'''", 'u"""', "U'''", 'U"""',
          "b'''", 'b"""', "B'''", 'B"""', "f'''", 'f"""', "F'''", 'F"""', "ur'''",
          'ur"""', "Ur'''", 'Ur"""', "uR'''", 'uR"""', "UR'''", 'UR"""', "br'''",
          'br"""', "Br'''", 'Br"""', "bR'''", 'bR"""', "BR'''", 'BR"""', "rb'''",
          'rb"""', "Rb'''", 'Rb"""', "rB'''", 'rB"""', "RB'''", 'RB"""'):
    triple_quoted[t] = t

single_quoted = {}
for t in ("'", '"', "r'", 'r"', "R'", 'R"', "u'", 'u"', "U'", 'U"', "b'", 'b"', "B'",
          'B"', "f'", 'f"', "F'", 'F"', "ur'", 'ur"', "Ur'", 'Ur"', "uR'", 'uR"',
          "UR'", 'UR"', "br'", 'br"', "Br'", 'Br"', "bR'", 'bR"', "BR'", 'BR"', "rb'",
          'rb"', "Rb'", 'Rb"', "rB'", 'rB"', "RB'", 'RB"'):
    single_quoted[t] = t
            ...
            if pseudomatch:
                ...
                if initial in numchars or initial == '.' and token != '.':
                    ...
                    if initial in '\r\n':
                        ...
                        assert initial == '#' and not token.endswith('\n')
                        if stashed:
                            yield stashed
                            stashed = None
                        yield (
