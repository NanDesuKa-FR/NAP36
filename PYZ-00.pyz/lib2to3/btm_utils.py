            ...
            if node.type == TYPE_ALTERNATIVES:
                ...
                if node.type == TYPE_GROUP:
                    ...
                    if len(node.group) == len(node.children):
                        ...
                        subp = None
                        break
            elif node.type == token_labels.NAME and node.name:
...
def reduce_tree(node, parent=None):
    ...
    if node.type == syms.Alternatives:
        ...
        if node.type == syms.Unit:
            if isinstance(node.children[0], pytree.Leaf):
            ...
            elif isinstance(node.children[0], pytree.Leaf) and node.children[0].value == '[' or len(node.children) > 1 and hasattr(node.children[1], 'value') and node.children[1].value == '[':
                return
            else:
                leaf = True
                details_node = None
                ...
                for child in node.children:
                    if child.type == syms.Details:
                        ...
                        if child.type == syms.Repeater:
                            has_repeater = True
                            repeater_node = child
                        else:
                            if child.type == syms.Alternatives:
            ...
            if name_leaf.type == token_labels.NAME:
                ...
                if name_leaf.type == token_labels.STRING:
