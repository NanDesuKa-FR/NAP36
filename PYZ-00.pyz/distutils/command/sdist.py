...
# Embedded file name: distutils\command\sdist.py
...
class sdist(Command):
    ...
    def read_template(self):
        ...
        template = TextFile((self.template), strip_comments=1, skip_blanks=1, join_lines=1,
          lstrip_ws=1,
          rstrip_ws=1,
          collapse_join=1)
        try:
    ...
    def make_distribution(self):
        ...
        for fmt in self.formats:
            file = self.make_archive(base_name, fmt, base_dir=base_dir, owner=(self.owner),
              group=(self.group))
