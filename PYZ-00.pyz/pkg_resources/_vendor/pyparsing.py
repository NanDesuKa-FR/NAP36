...
# Embedded file name: lib\site-packages\setuptools-39.0.1-py3.6.egg\pkg_resources\_vendor\pyparsing.py
"""
    ...
    def __init__(self, exprs, savelist=False):
        ...
        if isinstance(exprs, _generatorType):
            ...
            if isinstance(exprs, basestring):
                ...
                if isinstance(exprs, collections.Iterable):
                    exprs = list(exprs)
...
class Forward(ParseElementEnhance):
 ...
 L.4157         0  LOAD_GLOBAL              hasattr
                2  LOAD_FAST                'self'
                4  LOAD_STR                 'name'
                6  CALL_FUNCTION_2       2  '2 positional arguments'
                8  POP_JUMP_IF_FALSE    16  'to 16'

 L.4158        10  LOAD_FAST                'self'
               12  LOAD_ATTR                name
               14  RETURN_END_IF    
             16_0  COME_FROM             8  '8'

 L.4159        16  LOAD_FAST                'self'
 ...
 L.4168        28  LOAD_STR                 'None'
               30  STORE_FAST               'retString'
               32  POP_BLOCK        
               34  LOAD_CONST               None

 L.4170        36  LOAD_FAST                'self'
               38  LOAD_ATTR                _revertClass
               40  LOAD_FAST                'self'
               42  STORE_ATTR               __class__
               44  END_FINALLY      

 L.4171        46  LOAD_FAST                'self'
