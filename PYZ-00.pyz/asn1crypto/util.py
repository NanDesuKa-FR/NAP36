...
# Embedded file name: lib\site-packages\asn1crypto\util.py
"""
...
if sys.version_info <= (3, ):
    ...
    def int_from_bytes(value, signed=False):
        ...
        if value == b'':
            ...
            num = long(value.encode('hex'), 16)
            if not signed:
                return num
            if ord(value[0:1]) & 128:
                bit_len = len(value) * 8
