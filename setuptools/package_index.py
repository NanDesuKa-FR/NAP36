...
# Embedded file name: lib\site-packages\setuptools-39.0.1-py3.6.egg\setuptools\package_index.py
"""PyPI and direct package downloading"""
import sys, os, re, shutil, socket, base64, hashlib, itertools
...
class PackageIndex(Environment):
    ...
    def __init__(self, index_url='https://pypi.python.org/simple', hosts=('*',), ca_bundle=None, verify_ssl=True, *args, **kw):
