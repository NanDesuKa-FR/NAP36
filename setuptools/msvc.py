...
# Embedded file name: lib\site-packages\setuptools-39.0.1-py3.6.egg\setuptools\msvc.py
"""
    ...
    if 'vcvarsall' in message.lower() or 'visual c' in message.lower():
        ...
        if version == 9.0:
            ...
            if version == 10.0:
                ...
                message += ' Get it with "Microsoft Visual C++ Build Tools": http://landinghub.visualstudio.com/visual-cpp-build-tools'
    exc.args = (message,)
